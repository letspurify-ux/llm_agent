...
INSERT INTO query_registry (query_name, input_desc, query_sql, output_desc, target_db_name) VALUES
('batch_job_status', ':job_id = 배치 작업 ID (예: BATCH001)',
...
('find_customer_id', ':customer_name = 고객명 (한글)',
...
('order_status_by_customer', ':customer_id = find_customer_id 결과의 CUSTOMER_ID',
