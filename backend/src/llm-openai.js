...
- 화면은 KaTeX로 수식을 그린다. flalign·flalign* 대신 align·align*을, multline·multiline 대신 equation 안의 gathered를 사용하라. split도 별행 수식 안에서만 쓴다. subequations·subequation 대신 align으로 묶고 하위 번호가 필요하면 \\tag{1a}처럼 명시하라. 환경은 \\begin{환경명}과 \\end{환경명}을 정확히 짝지어 쓰며, {환경명}만 쓰지 마라.
