...
**버릴** 수 있습니다. 처리방법은 나누지 않으므로 1,000자에서 잘리고, 청구하면 문서당 상한(4,500자)까지 실립니다.
...
- **한 문서는 프롬프트에서 4,500자까지, 청구는 요청당 2번까지**입니다. 글자 수는 프롬프트에 실리는 형태로
  잽니다. 둘이 한 섹션에 몰려도 그 섹션의 최소 몫(10,000자) 안에 듭니다. 펼친 항목은 목록 맨 앞으로 옮기고
